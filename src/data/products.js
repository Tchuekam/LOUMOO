  ...
  "hotels": [
    {
      ...
      "specs": {
        "performance": {
          "performanceClass": "5-Star Luxury",
          "thermal": "Central AC + Climate Control"
        },
        "display": {
          "size": "45 m² Suite",
          "panelType": "Ocean & Port View",
          "brightness": "Natural Daylight + Blackout"
        },
        "battery": {
          "batteryLife": "24/7 Power Generator Backup",
          "fastCharging": "100% Uptime Guaranteed"
        },
        "connectivity": {
          "wifi": "High-speed Fiber Wi-Fi 6",
          "ports": "Smart TV + HDMI"
        },
        "commerce": {
          "warranty": "Instant Free Cancellation",
          "deliverySpeed": "Instant Keycard Check-in",
          "deliveryCity": "Douala (Bonanjo)",
      ...
      "stockQuantity": 1000,
      "stock": 1000,
      "inStockLabel": "In Stock (1,000+ pcs)"
    },
    {
      "id": "hotel-2",
  ...
  "electronics": [
    {
      ...
      "verdictHighlights": {
        "pros": [
          "Exceptional battery life (18h real-world)",
          "Fanless silent operation",
          "Featherweight 1.24 kg unibody",
          "Unbeatable XAF 745,000 value"
        ],
        "cons": [
          "8GB base RAM limit for heavy 4K timelines",
          "External support limited to 1 display"
        ],
    ...
    },
    {
      ...
      "verdictHighlights": {
        "pros": [
          "Stunning 120Hz Mini-LED XDR display (1600 nits)",
          "Heavy duty M3 Pro with 18GB RAM",
          "HDMI 2.1 & full-size SDXC card slot",
          "Six-speaker studio audio"
        ],
        "cons": [
          "Higher investment cost (XAF 1,250,000)",
          "Heavier at 1.61 kg compared to Air"
        ],
    ...
    },
    {
      ...
      "verdictHighlights": {
        "pros": [
          "Lightest laptop at 1.12 kg carbon fiber",
          "Unbeatable 3-year enterprise warranty",
          "Legendary ThinkPad keyboard & TrackPoint",
          "Legacy USB-A & full HDMI built-in"
        ],
        "cons": [
          "Intel Iris Xe graphics weaker for gaming & 3D render",
          "1080p display resolution lower than Retina"
        ],
    ...
    },
    {
      ...
      "verdictHighlights": {
        "pros": [
          "Breathtaking 3.5K OLED touchscreen display",
          "Dedicated NVIDIA RTX 4060 graphics",
          "Upgradable 32GB RAM & dual SSD slots",
          "Spacious 15.6-inch creative canvas"
        ],
        "cons": [
          "Shorter battery life (9h) due to RTX GPU & 3.5K OLED",
          "Heavier at 1.92 kg"
        ],
