    ...
    <div class="travel-search-widget">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px">
        <div style="background:var(--color-surface-subtle);border:1px solid var(--color-border-subtle);border-radius:var(--radius-md);padding:9px 12px">
          ...
          <input type="date" value="{{ travelDate }}" onInput="{{ updateTravelDate }}" aria-label="Departure date" style="width:100%;border:none;background:transparent;padding:0;font:600 12.5px/1.2 var(--font-body);color:var(--color-text);outline:none" />
        </div>
      ...
      <div class="card-premium" style="padding:24px;border-radius:var(--radius-xl);box-shadow:var(--shadow-sm)">
        <div style="display:flex;justify-content:space-between;align-items:center;border-bottom:1px solid var(--color-divider);padding-bottom:16px;margin-bottom:18px">
          <div>
            ...
            <div style="font:500 12px/1.2 var(--font-body);color:var(--color-text-secondary);margin-top:3px">{{ selectedTravelResult.title }}</div>
          </div>
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;padding:14px 18px;background:var(--color-surface-subtle);border-radius:var(--radius-md)">
          <div><div style="font:800 18px/1 var(--font-heading)">{{ selectedTravelResult.departure }}</div><div style="font:500 12px/1.3 var(--font-body);color:var(--color-text-secondary);margin-top:3px">{{ selectedTravelResult.origin }}</div></div>
          <div style="font:700 12px/1 var(--font-body);color:var(--color-text-muted)">{{ selectedTravelResult.duration }}</div>
          <div style="text-align:right"><div style="font:800 18px/1 var(--font-heading)">{{ selectedTravelResult.arrival }}</div><div style="font:500 12px/1.3 var(--font-body);color:var(--color-text-secondary);margin-top:3px">{{ selectedTravelResult.destination }}</div></div>
        </div>
      </div>
    </sc-if>
    <sc-if value="{{ !selectedTravelResult }}">
